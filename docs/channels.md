...
- **Source** names what generates the channel: the comms section that carries it ("CAN1 · Dash") or publishes its checksum to it ("CAN1 · Dash CRC8" — see [Transmit CRC8](communications.md#crc8)), or Math, User Condition, Counter, Timer, Integrator, Constant, Table 2x16, Table 8x8 — or **Internal** for a **Device Channel**, which the unit produces itself whether or not anything uses it — or "unused".
