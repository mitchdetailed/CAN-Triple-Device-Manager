...
<td>Renames AND updates every reference — comms rows, math, conditions.
...
<code>{channel, startBit, bitLength, dbcType, factor, offset, default}</code>
with <code>dbcType</code> = <code>"unsigned"|"signed"|"float"</code>.</td></tr>
