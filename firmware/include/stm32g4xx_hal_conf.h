...
#define HAL_MODULE_ENABLED
  ...
  #define HAL_ADC_MODULE_ENABLED   /* v9: internal temp sensor + VREFINT sampling */
...
/* Enabled for the configuration-password unlock challenge: the device must
 * answer with a nonce it has never used before, or a captured reply could be
 * replayed. Clocked from HSI48, which is independent of the PLL — see
 * SystemClock_Config, deliberately left untouched. */
