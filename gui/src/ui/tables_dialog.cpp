...
OutputControls buildOutputGroup(QWidget *parent, QVBoxLayout *layout, const QString &name,
...
public:
        ...
        : QDialog(parent), m_config(config), m_row(row)
    {
        ...
        m_out = buildOutputGroup(this, layout, row.outputChannel, row.dataType, row.decimalPlaces);
