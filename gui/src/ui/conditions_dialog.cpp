...
private:
    ...
    TermWidgets buildTerm(const Expr &e, int index, QVBoxLayout *parentLayout)
    {
        ...
        grid->addWidget(w.bChannelRadio, 2, 0);
        grid->addWidget(w.bChannelEdit, 2, 1);
        grid->addWidget(w.bSelect, 2, 2);
        grid->addWidget(w.bConstRadio, 3, 0);
        grid->addWidget(w.bConstSpin, 3, 1);
