...
// readable and editable in the app once the file is open; the bytes being
// opaque changes nothing about that, which is why saveToFile still refuses to
// write a document whose keyed sections are concealed from this session.
//
// ---------------------------------------------------------------------------
// READING FORMAT 1
//
