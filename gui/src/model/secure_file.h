...
//       The file key is additionally wrapped under the Edit Protected Comms
...
struct SecureSaveOptions
{
    ...
    // The Edit Protected Comms password. Required when requirePassword is set;
    // otherwise unused.
    QString password;
    // The 4-byte Edit Protected Comms key carried in the file, so this app can
